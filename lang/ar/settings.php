...
return [
    ...
    'intro_video_section_title' => 'فيديو تعريفي',
    'intro_video_label' => 'فيديو تعريفي',
    'intro_video_hint' => 'MP4 أو WebM أو MOV أو AVI أو MKV — حتى 256 ميجابايت و 10 دقائق.',
    'intro_video_upsell' => 'قدّم عملك بفيديو. ميزة الفيديو التعريفي متاحة في خطة Pro.',
    'intro_video_upsell_cta' => 'عرض الخطط',
    'intro_video_remove' => 'إزالة الفيديو',
    'intro_video_save_button' => 'رفع الفيديو',
    'intro_video_saving' => 'جارٍ الرفع...',
    'intro_video_saved' => 'تم رفع الفيديو التعريفي بنجاح.',
    'intro_video_removed' => 'تمت إزالة الفيديو التعريفي.',
    'intro_video_ineligible' => 'ميزة الفيديو التعريفي غير متضمنة في خطة هذه الشركة الحالية.',
    'intro_video_validation_duration' => 'يجب ألا يتجاوز طول الفيديو 10 دقائق.',
