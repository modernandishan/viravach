...
return [
    ...
    'content_write_manually' => 'Написать контент вручную',
    'content_manual_mode_notice' => 'Эта компания использует контент, введённый вручную; генерация контента с ИИ для неё недоступна.',
    'content_manual_seeded' => 'Создан пустой каркас контента для вашей компании. Заполните его в редакторе ниже.',
