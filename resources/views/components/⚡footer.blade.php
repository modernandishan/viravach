...
new class extends Component
{
    ...
    /**
     * The footer's CSS, assembled here and raw-echoed (never written as a
     * literal <style> tag in the template) for the same reason as
     * ⚡company-card.blade.php's cardStyles(): Livewire's SFC compiler
     * statically scans the .blade.php SOURCE for a literal <style> block
     * and extracts it into a "styleModule" asset that this app registers
     * no route to serve, so a real <style> tag here would silently never
     * reach the page. Building the tag as a string and echoing it with
     * {!! !!} is invisible to that static scan. @once in the caller keeps
     * it to one copy per page.
     */
    public function footerStyles(): string
    {
        return <<<'CSS'
            <style>
            .vv-footer {
            ...
            :lang(fa) .vv-footer,
            :lang(ar) .vv-footer {
                /* DESIGN.md §3: Persian/Arabic read smaller at a given pixel
                   size than Latin, so body text gets +1px. Headings are not
                   scaled. */
                font-size: 16px;
            }
            .vv-footer a {
            ...
            .vv-footer-social-btn {
                ...
                block-size: 36px;
                border-radius: 999px;
                background: var(--vv-ink-700);
                color: #FFFFFF;
                transition: background-color .15s ease-out;
            }
            .vv-footer-social-btn:hover {
                background: var(--vv-primary-700);
                color: #FFFFFF;
            }
            .vv-footer-contact {
            ...
            .vv-footer-locale:hover {
                color: #FFFFFF;
            }
            .vv-footer-locale.is-active {
                color: #FFFFFF;
                font-weight: 600;
            }
            .vv-footer-bottom {
